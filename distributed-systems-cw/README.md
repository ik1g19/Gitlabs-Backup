This project implements a distributed file store system using Java. The system allows clients to connect to a controller and store files across multiple data stores.
