A Java-based Sudoku solver that uses a backtracking algorithm to find solutions to Sudoku puzzles. The solver also includes features such as hint functionality and animation for win conditions.
